            ...
            <div className="w-64 bg-gray-900 text-white flex flex-col">
                <div className="p-4 border-b border-gray-700">
                    <button
                        ...
                        className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded transition duration-200 flex items-center justify-center gap-2"
                    >
                        <span>+</span> New Chat
                    </button>
                </div>
                            ...
                            {editingSessionId === session.id ? (
                                ...
                                <div className="flex items-center">
                                    <button
                                        ...
                                        className={`flex-1 text-left px-3 py-2 rounded truncate transition ${currentSessionId === session.id
